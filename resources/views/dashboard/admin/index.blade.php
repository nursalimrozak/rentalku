						...
						<div class="card flex-fill">
							<div class="card-body">
								<div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
									...
									<a href="cars.html" class="text-decoration-underline fw-medium">View All</a>
								</div>
								<div class="mb-2">
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center gap-3">
													...
													<a href="javascript:void(0);" class="avatar avatar-sm">
														<img src="{{ asset('admin_assets/images/avatar-23.jpg') }}" alt="img" class="rounded-circle">
													</a>
												</div>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<div class="d-flex align-items-center gap-3">
													...
													<a href="javascript:void(0);" class="avatar avatar-sm">
														<img src="{{ asset('admin_assets/images/avatar-06.jpg') }}" alt="img" class="rounded-circle">
													</a>
												</div>
											</td>
										</tr>
									...
									<table class="table custom-table1">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<a href="customer-details.html" class="avatar flex-shrink-0">
														<img src="{{ asset('admin_assets/images/customer-04.jpg') }}" class="rounded-circle" alt="">
													</a>
													<div class="flex-grow-1 ms-2">
														<h6 class="fs-14 fw-semibold mb-1"><a href="customer-details.html">Adam Bolden</a></h6>
														<span class="badge badge-sm bg-secondary-transparent rounded-pill">Client</span>
													</div>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<a href="customer-details.html" class="avatar flex-shrink-0">
														<img src="{{ asset('admin_assets/images/customer-05.jpg') }}" class="rounded-circle" alt="">
													</a>
													<div class="flex-grow-1 ms-2">
														<h6 class="fs-14 fw-semibold mb-1"><a href="customer-details.html">Harvey Jimenez</a></h6>
														<span class="badge badge-sm bg-violet-transparent rounded-pill">Company</span>
													</div>
												</div>
											</td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<a href="customer-details.html" class="avatar flex-shrink-0">
														<img src="{{ asset('admin_assets/images/customer-06.jpg') }}" class="rounded-circle" alt="">
													</a>
													<div class="flex-grow-1 ms-2">
														<h6 class="fs-14 fw-semibold mb-1"><a href="customer-details.html">William Ward</a></h6>
														<span class="badge badge-sm bg-secondary-transparent rounded-pill">Client</span>
													</div>
												</div>
											</td>
									...
									<table class="table custom-table1">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar flex-shrink-0">
														<img src="{{ asset('admin_assets/images/driver-03.jpg') }}" class="rounded-circle" alt="">
													</a>
													<div class="flex-grow-1 ms-2">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar flex-shrink-0">
														<img src="{{ asset('admin_assets/images/driver-04.jpg') }}" class="rounded-circle" alt="">
													</a>
													<div class="flex-grow-1 ms-2">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar flex-shrink-0">
														<img src="{{ asset('admin_assets/images/driver-05.jpg') }}" class="rounded-circle" alt="">
													</a>
													<div class="flex-grow-1 ms-2">
														<h6 class="fs-14 fw-semibold mb-1"><a href="javascript:void(0);">William Jones</a></h6>
