                                ...
                                <div class="col-xl-9">
                                    <div class="d-flex align-items-center flex-wrap row-gap-3 upload-pic">
                                        <div class="d-flex align-items-center justify-content-center avatar avatar-xxl me-3 flex-shrink-0 border rounded-circle frames">
                                            <img src="{{ $driver->photo ? asset($driver->photo) : asset('admin_assets/images/profile-placeholder.jpg') }}" class="img-fluid rounded-circle" alt="driver" id="image-preview" onerror="this.src='{{ asset('admin_assets/images/user.jpg') }}'">
                                        </div>   
                                        <div>
                            ...
                            <div class="row row-gap-4">
                                ...
                                <div class="col-xl-9">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="e.g. John Doe" required value="{{ old('name', $driver->name) }}">
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Phone Number <span class="text-danger">*</span></label>
                                                <input type="text" name="phone_number" class="form-control" placeholder="e.g. 08123456789" required value="{{ old('phone_number', $driver->phone_number) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="date_of_birth" class="form-control" required value="{{ old('date_of_birth', $driver->date_of_birth ? $driver->date_of_birth->format('Y-m-d') : '') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="bio" class="form-control" rows="3">{{ old('bio', $driver->bio) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="in_city_rate" class="form-control" required value="{{ old('in_city_rate', $driver->in_city_rate) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Out-of-Town Rate (Per Day) <span class="text-danger">*</span></label>
                                                <input type="number" name="out_of_town_rate" class="form-control" required value="{{ old('out_of_town_rate', $driver->out_of_town_rate) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Experience (Years) <span class="text-danger">*</span></label>
                                                <input type="number" name="experience_years" class="form-control" required value="{{ old('experience_years', $driver->experience_years) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <fieldset>
                        ...
                        <div class="border-bottom mb-4 pb-2">                               
                            <div class="row row-gap-4">
                                ...
                                <div class="col-xl-9">
                                    <div class="mb-3">
                                        <label class="form-label">SIM (Driving License)</label>
                                        @if($driver->sim)
                                            <div class="mb-2">
                                                <a href="{{ asset($driver->sim) }}" target="_blank" class="text-primary"><i class="ti ti-eye me-1"></i>View Current SIM</a>
                                            </div>
                                        @endif
                                        <input type="file" name="sim" class="form-control" accept="image/*">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">KTP (ID Card)</label>
                                        @if($driver->ktp)
                                            <div class="mb-2">
                                                <a href="{{ asset($driver->ktp) }}" target="_blank" class="text-primary"><i class="ti ti-eye me-1"></i>View Current KTP</a>
                                            </div>
                                        @endif
                                        <input type="file" name="ktp" class="form-control" accept="image/*">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">KK (Family Card)</label>
                                        @if($driver->kk)
                                            <div class="mb-2">
                                                <a href="{{ asset($driver->kk) }}" target="_blank" class="text-primary"><i class="ti ti-eye me-1"></i>View Current KK</a>
                                            </div>
                                        @endif
                        ...
                        <div class="d-flex align-items-center justify-content-end pt-3">
                            <button type="button" class="btn btn-outline-light border wizard-prev me-2"><i class="ti ti-chevron-left me-1"></i>Back</button>
                            <button type="submit" class="btn btn-primary d-flex align-items-center"><i class="ti ti-check me-1"></i>Update Driver</button>
                        </div>
                    </fieldset>
                </form>
            </div>
