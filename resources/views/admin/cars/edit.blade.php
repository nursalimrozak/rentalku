                ...
                <form action="{{ route('admin.cars.update', $car->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset id="first-field">
                        <div class="filterbox p-20 mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <h4 class="d-flex align-items-center"><i class="ti ti-info-circle text-secondary me-2"></i>Edit Basic Info</h4>
                        </div>
                                ...
                                <div class="col-xl-9">
                                    <div class="d-flex align-items-center flex-wrap row-gap-3 upload-pic">
                                        <div class="d-flex align-items-center justify-content-center avatar avatar-xxl me-3 flex-shrink-0 border rounded-circle frames">
                                            @if($car->photo)
                                                <img src="{{ asset($car->photo) }}" class="img-fluid rounded-circle" alt="car" id="image-preview" style="width: 100%; height: 100%; object-fit: cover;">
                                            @else
                        ...
                        <div class="border-bottom mb-2 pb-2">                               
                            <div class="row row-gap-4">
                                <div class="col-xl-3">
                                    ...
                                    <p>Edit Information About Car</p>
                                </div>
                                <div class="col-xl-9">
                                    <div class="mb-3">
                                        <label class="form-label">Name <span class="text-danger">*</span></label>
                                        <input type="text" name="name" class="form-control" value="{{ old('name', $car->name) }}" placeholder="e.g. Innova Reborn V" required>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Car Type <span class="text-danger">*</span></label>
                                                <input type="text" name="car_type" class="form-control" list="car_type_list" value="{{ old('car_type', $car->car_type) }}" placeholder="Select or Type New" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="brand" class="form-control" list="brand_list" value="{{ old('brand', $car->brand) }}" placeholder="Select or Type New" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="model" class="form-control" list="model_list" value="{{ old('model', $car->model) }}" placeholder="Select or Type New" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="color" class="form-control" list="color_list" value="{{ old('color', $car->color) }}" placeholder="Select or Type New" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="year" class="form-control" list="year_list" value="{{ old('year', $car->year) }}" placeholder="YYYY" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="transmission" class="form-control" list="transmission_list" value="{{ old('transmission', $car->transmission) }}" placeholder="Select or Type New" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="fuel_type" class="form-control" list="fuel_type_list" value="{{ old('fuel_type', $car->fuel_type) }}" placeholder="Select or Type New" required>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="seating_capacity" class="form-control" list="seating_list" value="{{ old('seating_capacity', $car->seating_capacity) }}" placeholder="e.g. 5" required>
                    ...
                    <fieldset>
                        <div class="filterbox p-20 mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <h4 class="d-flex align-items-center"><i class="ti ti-files text-secondary me-2"></i>Edit Pricing & Fees</h4>
                        </div>                                      
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="rental_rate_per_day" id="rate_daily" class="form-control" value="{{ old('rental_rate_per_day', $car->rental_rate_per_day) }}" required oninput="calculateRates()">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Rental Rate Per Week (7 Days)</label>
                                                <input type="number" name="rental_rate_per_week" id="rate_weekly" class="form-control" value="{{ old('rental_rate_per_week', $car->rental_rate_per_week) }}" placeholder="Auto-calculated">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Rental Rate Per Month (30 Days)</label>
                                                <input type="number" name="rental_rate_per_month" id="rate_monthly" class="form-control" value="{{ old('rental_rate_per_month', $car->rental_rate_per_month) }}" placeholder="Auto-calculated">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Penalty Per KM (IDR)</label>
                                                <input type="number" name="penalty_per_km" class="form-control" value="{{ old('penalty_per_km', $car->penalty_per_km) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="driver_fee_in_city" class="form-control" required value="{{ old('driver_fee_in_city', $car->driver_fee_in_city) }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Driver Fee Out Town (IDR) <span class="text-danger">*</span></label>
                                                <input type="number" name="driver_fee_out_town" class="form-control" required value="{{ old('driver_fee_out_town', $car->driver_fee_out_town) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <fieldset>
                        <div class="filterbox p-20 mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                            <h4 class="d-flex align-items-center"><i class="ti ti-photo text-secondary me-2"></i>Edit Car Gallery</h4>
                        </div>
                        <div class="border-bottom mb-4 pb-2">                               
                            <div class="row row-gap-4">
                                <div class="col-xl-3">
                                    <h6 class="mb-1">Gallery Images</h6>
                                    <p>Add new photos to gallery (Existing photos will be kept). Max 5 total.</p>
                                </div>
                                <div class="col-xl-9">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-2 mb-3 flex-wrap">
                                            @foreach($car->images as $image)
                                                <img src="{{ asset($image->image_path) }}" class="rounded border" style="width: 100px; height: 100px; object-fit: cover;">
                                            @endforeach
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Upload New Photos (Max 2MB each)</label>
                        ...
                        <div class="d-flex align-items-center justify-content-end pt-3">
                            <button type="button" class="btn btn-outline-light border wizard-prev me-2"><i class="ti ti-chevron-left me-1"></i>Back</button>
                            <button type="submit" class="btn btn-primary d-flex align-items-center">Update Car</button>
                        </div>
                    </fieldset>
                </form>
            </div>
    ...
    document.querySelectorAll('.wizard-next').forEach(btn => {
        btn.addEventListener('click', () => {
             ...
             if(next) {
                 ...
                 updateNav(Array.from(document.querySelectorAll('.add-wizard fieldset')).indexOf(next)); 
             }
        });
    });
    ...
    document.querySelectorAll('.wizard-prev').forEach(btn => {
        btn.addEventListener('click', () => {
             ...
             if(prev) {
                 ...
                 updateNav(Array.from(document.querySelectorAll('.add-wizard fieldset')).indexOf(prev));
             }
        });
    });
